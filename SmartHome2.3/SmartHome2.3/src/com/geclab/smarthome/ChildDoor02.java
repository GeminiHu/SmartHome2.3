...
public class ChildDoor02 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.child_door02);
	...
	public void onBtnSetDoorState(View v){
		...
		if ((socket==null) || (!(socket.isConnected()))) {
			new AlertDialog.Builder(ChildDoor02.this).setTitle("网络连接").setMessage("未连接上服务器")  
