...
public class ChildAir02 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.child_air02);
		
		initVariables();
	}
	
	private void initVariables(){
		airState = (TextView)findViewById(R.id.tvAirSate);
	...
	public void onBtnSetAir(View v){
		...
		if ((socket==null) || (!(socket.isConnected()))) {
			new AlertDialog.Builder(ChildAir02.this).setTitle("网络连接").setMessage("未连接上服务器")  
		...
		if (HomeConfig.AIRCONDITIONING_STATUE) {
			...
			airState.setText("关");
			Toast.makeText(ChildAir02.this,
	...
	private void processThread(){
	      //构建一个下载进度条
	      pd = ProgressDialog.show(ChildAir02.this, "空调还在操作中", "空调还在操作中...请稍后再试...");
	      new Thread(){
	         public void run(){
	            //在这里执行长耗时方法
	            while(!isClickable){
