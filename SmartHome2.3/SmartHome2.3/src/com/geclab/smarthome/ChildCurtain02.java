...
public class ChildCurtain02 extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.child_curtain02);
		initVars();
	}
	...
	public void onBtnSetCurtain(View v){
		if ((socket==null) || (!(socket.isConnected()))) {
			new AlertDialog.Builder(ChildCurtain02.this).setTitle("网络连接").setMessage("未连接上服务器")  
		...
		if (HomeConfig.CURTAIN_STATUE) {
			...
			curtainState.setText("关");
			Toast.makeText(ChildCurtain02.this, "窗帘已关闭",
					Toast.LENGTH_SHORT).show();
		} else {
			out.println("P");		//控制窗帘开
			curtainState.setText("开");
			HomeConfig.CURTAIN_STATUE = true;
			Toast.makeText(ChildCurtain02.this, "窗帘已打开",
					Toast.LENGTH_SHORT).show();
		}
	}
}
